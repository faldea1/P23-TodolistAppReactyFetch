    ...
    return (
        <div className="container">
            ...
            <ul>
                ...
                {listoftodos.map((task, index) => (<li className='d-flex justify-content-between'>{task}<span><FaTrash onClick={() => setlistoftodos(listoftodos.filter((t, currentIndex) => index != currentIndex))} /></span></li>))}
            </ul>
